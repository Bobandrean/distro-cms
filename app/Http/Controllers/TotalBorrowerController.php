...
class TotalBorrowerController extends Controller
{
    private $request;
    ...
    {
        $items = $this->purchaseOrderService->totalBorrowerDatatables($this->request);   
        ...
        return view('contents.borrower.index',compact('items','request','suppliers','customers','paymentTypes'));
    }
}
