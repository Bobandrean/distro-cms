                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr class="text-center">
                                                    <th>@lang('pages/disbursement.table.col_2')</th>
                                                    <th>@lang('pages/disbursement.table.col_4')</th>
                                                    <th>@lang('pages/disbursement.table.col_5')</th>
                                                    <th width="150px">@lang('pages/disbursement.table.col_6')</th>
                                                    <th>@lang('pages/disbursement.table.col_7')</th>
                                                    <th>@lang('pages/disbursement.table.col_1')</th>
                                                    <th>@lang('pages/disbursement.table.col_12')</th>
                                                    <th>@lang('pages/disbursement.table.col_8')</th>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <th colspan="7">
                                                        ...
                                                        <a href="{{ route('disbursement.index') }}" class="btn btn-sm btn-danger"><i class="fas fa-fw fa-times"></i> @lang('global.reset_button_txt')</a>
                                                ...
                                                @foreach($items as $item)
                                                    <tr>
                                                        ...
                                                        @if($item->po_detail->tanggal_pencairan == NULL)
                                                        <td></td>
                                                        @else
                                                        <td>{{ \Carbon\Carbon::parse($item->po_detail->tanggal_pencairan)->format('Y-m-d') }}</td>
                                                        @endif
                                                        @if($item->po_detail->jatuh_tempo == NULL)
                                                        <td></td>
                                                        @else
