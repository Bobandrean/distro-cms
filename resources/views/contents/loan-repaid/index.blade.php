                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr class="text-center">
                                                    <th width="100px">@lang('pages/loan-repaid.table.col_12')</th>
                                                    <th width="140px">@lang('pages/loan-repaid.table.col_14')</th>
                                                    <th>@lang('pages/loan-repaid.table.col_2')</th>
                                                    <!-- <th>@lang('pages/loan-repaid.table.col_3')</th> -->
                                                    <th width="200px">@lang('pages/loan-repaid.table.col_4')</th>
                                                    <th width="200px">@lang('pages/loan-repaid.table.col_5')</th>
                                                    <th width="150px">@lang('pages/loan-repaid.table.col_6')</th>
                                                    <th width="100px">@lang('pages/loan-repaid.table.col_7')</th>
                                                    <th width="140px">@lang('pages/loan-repaid.table.col_13')</th>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <th colspan="5">
                                                        ...
                                                        <a href="{{ route('loan-repaid.index') }}" class="btn btn-sm btn-danger"><i class="fas fa-fw fa-times"></i> @lang('global.reset_button_txt')</a>
