                ...
                <div class="card-body">
                    <form action="{{ route('notification.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="notification" value="{{ $item->notification }}">
                        </div>

                        <div class="form-group">
                            <label for="">@lang('pages/notification.form.data_label')</label>
                            <input type="text" class="form-control form-control-sm" name="data" value="{{$item->data }}">
                        </div>
