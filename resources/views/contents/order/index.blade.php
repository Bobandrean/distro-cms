                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr class="text-center">
                                                    <th>@lang('pages/order.table.col_1')</th>
                                                    <th>@lang('pages/order.table.col_2')</th>
                                                    <th>@lang('pages/order.table.col_3')</th>
                                                    <th>@lang('pages/order.table.col_4')</th>
                                                    <th>@lang('pages/order.table.col_5')</th>
                                                    <th>@lang('pages/order.table.col_6')</th>
                                                    <th>@lang('pages/order.table.col_7')</th>
                                                    <th>@lang('pages/order.table.col_8')</th>
                                                    <th>@lang('pages/order.table.col_9')</th>
                                                    <th>@lang('pages/order.table.col_10')</th>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <th colspan="5">
                                                        ...
                                                        <a href="{{ route('order.index') }}" class="btn btn-sm btn-danger"><i class="fas fa-fw fa-times"></i> @lang('global.reset_button_txt')</a>
                                                ...
                                                @foreach($items as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->kode_po }}</td>
                                                        <td>{{ $item->pemasok->nama_perusahaan }} <br> ({{ $item->pemasok->nama_pic }})</td>
