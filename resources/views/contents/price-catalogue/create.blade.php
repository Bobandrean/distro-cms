    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('price-catalogue.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="buyer_type" class="form-control form-control-sm">
                                    ...
                                    @foreach($buyerTypes as $buyerType)
                                        <option value="{{ $buyerType->id }}">{{ $buyerType->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="selling_price" class="form-control form-control-sm selling-price" value="{{ old('selling_price') }}" onchange="calc()">
                            </div>
                            <div class="form-group">
                                <label for="">@lang('pages/price-catalogue.form.het_label')</label>
                                <input type="text" name="het" class="form-control form-control-sm het" value="{{ old('het') }}" onchange="calc()">
                            </div>
