...
<div class="container">
    ...
    <table width="100%" cellpadding='3' cellspacing='3'>
        ...
        {{--                <td align="center">Rp{{ number_format($item->biaya_layanan,2,".",",") }}</td>--}}
        {{--            </tr>--}}
        {{--            <tr>--}}
        {{--                <td colspan="3" align="right" style="height:30px;"><b>Biaya Pengiriman ({{ $item->pemasok->nama_pic }}) : </b></td>--}}
        {{--                <td align="left">Rp{{number_format($item->biaya_pengiriman,2,".",",")}}</td>--}}
        {{--            </tr>--}}
        {{--            <tr>--}}
        {{--                <td colspan="3" align="right"><b>Biaya Bunga : </b></td>--}}
        {{--                <td align="center">Rp{{ number_format($item->biaya_bunga,2,".",",") }}</td>--}}
        {{--            </tr>--}}
        {{--            <tr>--}}
        {{--                <td colspan="3" align="right" style="height:30px;"><b>Total : </b></td>--}}
        {{--                <td align="left">Rp{{ number_format($item->total,2,".",",") }}</td>--}}
        {{--            </tr>--}}
        </tfoot>
    </table>
