    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('stock.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="product" class="form-control form-control-sm" disabled>
                                    ...
                                    @foreach($products as $product)
                                        <option value="{{ $product->id }}" @if($product->id == $item->id_produk) selected @endif>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="stock_minimum" class="form-control form-control-sm stock-minimum" value="{{ number_format($item->stok_minimum) }}" onchange="calc()">
                            </div>
                            <div class="form-group">
                                <label for="">@lang('pages/stock.form.stock_quantity_label')</label>
                                <input type="text" name="stock_quantity" class="form-control form-control-sm stock-quantity" value="{{ number_format($item->jumlah_stok) }}" onchange="calc()">
                            </div>
